...
const PACKAGES: Plan[] = [
  {
    ...
    priceEn: '$10',
    descZh: '适合轻量体验',
    descEn: 'For light usage',
    featuresZh: ['支付 $10', '到账 $11', '适合个人开发者试用'],
    featuresEn: ['Pay $10', 'Get $11 balance', 'Great for trying out'],
    highlight: true,
    ctaZh: '立即购买',
    ctaEn: 'Buy Now',
    fixedAmount: 10,
  ...
  },
  {
    ...
    featuresZh: ['支付 $50', '到账 $58', '所有模型可用'],
    featuresEn: ['Pay $50', 'Get $58 balance', 'Access all models'],
    highlight: false,
    ctaZh: '立即购买',
    ctaEn: 'Buy Now',
    fixedAmount: 50,
  ...
  },
  {
    ...
    featuresZh: ['支付 $100', '到账 $120', '优先技术支持'],
    featuresEn: ['Pay $100', 'Get $120 balance', 'Priority support'],
    highlight: false,
    ctaZh: '立即购买',
    ctaEn: 'Buy Now',
    fixedAmount: 100,
  ...
  return (
    <div className='tmp-modal-overlay'>
      <div className='tmp-modal-box'>
        <h3 className='tmp-modal-title'>{zh ? pkg.nameZh : pkg.nameEn}</h3>
        <p className='tmp-modal-desc'>{zh ? pkg.descZh : pkg.descEn}</p>
