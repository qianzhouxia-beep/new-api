...
var defaultModelRatio = map[string]float64{
	...
	// deepseek-v4-* models are the official replacements for deepseek-chat/reasoner
	// deepseek-chat and deepseek-reasoner deprecated on 2026-07-24
	"deepseek-v4-flash":      0.27 / 2, // V4 Flash non-thinking (maps to deepseek-chat)
	"deepseek-v4-pro":        0.40,     // V4 Pro premium model (~3x V4 Flash upstream cost)
